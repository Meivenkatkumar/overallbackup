...
<img id='profilepic1' src='".$picture."' class='img' height='250' width='250'> <div class='imgoverlay'></div>
 ...
 ?>
    ...
    <div class="col-sm-6 text-center">
      ...
      ?>
      <div id="testreport" style="min-height:400px;"></div>
      <div id="testreport1" style="height: auto;max-width:600px;"></div>
      <div id="testreport2" style="height: auto;max-width:600px;"></div>
      <div id="testreport3" style="height:auto;max-width:600px;"></div>
      </div>
    </div>
    <div class="col-sm-3 text-center">
      <div id="studentboard"  style="width: 100%;margin-top: 20px;">
      </div>
    </div>
  </div>
</div>
...
function drawspecialBarGraph(){
  ...
  $sql="SELECT qid,timetaken FROM answerrecords WHERE testname='".$testnames[$testindex]."' AND studentname='".$_SESSION['STUDENTNAME']."'";
    mysqli_stmt_prepare($stmt,$sql);
    mysqli_stmt_execute($stmt);
    ...
    ?>]);
   var option={
    title:"<?php echo $testnames[$testindex];?>",
    vAxis: {title: 'questiontime'},
