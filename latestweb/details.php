...
<div class="row">
  ...
  if($type!="student")
  {
    ...
    elseif(isset($_POST['attendance']))
    {
      ...
      while($row=$rows->fetch_assoc())
      {
        echo "<div class='custom-control custom-radio'><input type='checkbox' class='custom-control-input' name='attended[]' value='".$row['studentname']."'><label class='custom-control-label'>Present ".$row['studentname']."</label></div>";
      }
    ...
    else
    {
      ...
      {
       echo $studentname." has submitted assignment on ".$coursename."<a href='".$data."'>Click here...</a>";
      }
    }
}
?>
